...
#ifndef DIAMOND_GEAR_SWIFT_H
#define DIAMOND_GEAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="diamond_gear",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12diamond_gear11AppDelegate")
...
SWIFT_CLASS("_TtC12diamond_gear17MainFlutterWindow")
